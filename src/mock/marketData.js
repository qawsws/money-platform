...
export const cryptoPrices = [
  { id: 1, name: 'Bitcoin', symbol: 'BTC', price: '$64,250', change: '+5.32%', isPositive: true, image: 'BTC' },
  { id: 2, name: 'Ethereum', symbol: 'ETH', price: '$3,450', change: '+3.21%', isPositive: true, image: 'ETH' },
  { id: 3, name: 'Ripple', symbol: 'XRP', price: '$2.85', change: '-1.45%', isPositive: false, image: 'XRP' },
];
